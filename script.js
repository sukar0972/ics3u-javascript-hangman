...
function easyMode(word) {
    ...
    document.onkeydown = function (e) {
        ...
        if (alphabet.includes(e.key.toLowerCase())  && guessResults[1]!=5 && lives>0) {
        ...
        if (e.key == "Enter" && guessResults[1]!=5 && lives>0) {
...
function winner(attempts) {
    ...
    drawText("Wanna play again?",300,650,"white",24,"arial");
    drawText("Refresh the page",300,700,"white",24,"arial");
}
